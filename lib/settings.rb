...
class Settings
  ...
  attr_reader :solrmarc_dist_dir, :solrmarc_conf_props_file, :solr_url, :solrj_jar_dir, :solrj_queue_size, :solrj_num_threads, :lucene_req_handler
  ...
  def initialize(settings_group)
    ...
    @lucene_req_handler = yml["lucene_req_handler"]
  ...
  def as_hash
    {:solrmarc_dist_dir => @solrmarc_dist_dir,
      ...
      :solr_url => @solr_url,
      :lucene_req_handler => @lucene_req_handler,
